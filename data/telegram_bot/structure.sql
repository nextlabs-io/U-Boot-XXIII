...
CREATE TABLE IF NOT EXISTS `{TABLE_PREFIX}chat` (
...
CREATE TABLE IF NOT EXISTS `{TABLE_PREFIX}user_chat` (
                                           `user_id` bigint COMMENT 'Unique user identifier',
                                           `chat_id` bigint COMMENT 'Unique user or chat identifier',

                                           PRIMARY KEY (`user_id`, `chat_id`),

                                           FOREIGN KEY (`user_id`) REFERENCES `{TABLE_PREFIX}user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
                                           FOREIGN KEY (`chat_id`) REFERENCES `{TABLE_PREFIX}chat` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;

CREATE TABLE IF NOT EXISTS `{TABLE_PREFIX}inline_query` (
...
CREATE TABLE IF NOT EXISTS `{TABLE_PREFIX}chosen_inline_result` (
...
CREATE TABLE IF NOT EXISTS `{TABLE_PREFIX}message` (
                                         ...
                                         FOREIGN KEY (`user_id`) REFERENCES `{TABLE_PREFIX}user` (`id`),
                                         FOREIGN KEY (`chat_id`) REFERENCES `{TABLE_PREFIX}chat` (`id`),
                                         FOREIGN KEY (`forward_from`) REFERENCES `{TABLE_PREFIX}user` (`id`),
                                         FOREIGN KEY (`forward_from_chat`) REFERENCES `{TABLE_PREFIX}chat` (`id`),
                                         FOREIGN KEY (`reply_to_chat`, `reply_to_message`) REFERENCES `{TABLE_PREFIX}message` (`chat_id`, `id`),
                                         FOREIGN KEY (`via_bot`) REFERENCES `{TABLE_PREFIX}user` (`id`),
                                         FOREIGN KEY (`left_chat_member`) REFERENCES `{TABLE_PREFIX}user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;

CREATE TABLE IF NOT EXISTS `{TABLE_PREFIX}edited_message` (
                                                `id` bigint UNSIGNED AUTO_INCREMENT COMMENT 'Unique identifier for this entry',
                                                `chat_id` bigint COMMENT 'Unique chat identifier',
                                                ...
                                                FOREIGN KEY (`chat_id`) REFERENCES `{TABLE_PREFIX}chat` (`id`),
                                                FOREIGN KEY (`chat_id`, `message_id`) REFERENCES `{TABLE_PREFIX}message` (`chat_id`, `id`),
                                                FOREIGN KEY (`user_id`) REFERENCES `{TABLE_PREFIX}user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;

CREATE TABLE IF NOT EXISTS `{TABLE_PREFIX}callback_query` (
                                                `id` bigint UNSIGNED COMMENT 'Unique identifier for this query',
                                                `user_id` bigint NULL COMMENT 'Unique user identifier',
...
CREATE TABLE IF NOT EXISTS `{TABLE_PREFIX}shipping_query` (
...
CREATE TABLE IF NOT EXISTS `{TABLE_PREFIX}pre_checkout_query` (
                                                    `id` bigint UNSIGNED COMMENT 'Unique query identifier',
                                                    `user_id` bigint COMMENT 'User who sent the query',
...
CREATE TABLE IF NOT EXISTS `{TABLE_PREFIX}poll` (
...
CREATE TABLE IF NOT EXISTS `{TABLE_PREFIX}poll_answer` (
                                             ...
                                             FOREIGN KEY (`poll_id`) REFERENCES `{TABLE_PREFIX}poll` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;

CREATE TABLE IF NOT EXISTS `{TABLE_PREFIX}telegram_update` (
                                                 ...
                                                 FOREIGN KEY (`chat_id`, `message_id`) REFERENCES `{TABLE_PREFIX}message` (`chat_id`, `id`),
                                                 FOREIGN KEY (`edited_message_id`) REFERENCES `{TABLE_PREFIX}edited_message` (`id`),
                                                 FOREIGN KEY (`chat_id`, `channel_post_id`) REFERENCES `{TABLE_PREFIX}message` (`chat_id`, `id`),
                                                 FOREIGN KEY (`edited_channel_post_id`) REFERENCES `{TABLE_PREFIX}edited_message` (`id`),
                                                 FOREIGN KEY (`inline_query_id`) REFERENCES `{TABLE_PREFIX}inline_query` (`id`),
                                                 FOREIGN KEY (`chosen_inline_result_id`) REFERENCES `{TABLE_PREFIX}chosen_inline_result` (`id`),
                                                 FOREIGN KEY (`callback_query_id`) REFERENCES `{TABLE_PREFIX}callback_query` (`id`),
                                                 FOREIGN KEY (`shipping_query_id`) REFERENCES `{TABLE_PREFIX}shipping_query` (`id`),
                                                 FOREIGN KEY (`pre_checkout_query_id`) REFERENCES `{TABLE_PREFIX}pre_checkout_query` (`id`),
                                                 FOREIGN KEY (`poll_id`) REFERENCES `{TABLE_PREFIX}poll` (`id`),
                                                 FOREIGN KEY (`poll_answer_poll_id`) REFERENCES `{TABLE_PREFIX}poll_answer` (`poll_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;

CREATE TABLE IF NOT EXISTS `{TABLE_PREFIX}conversation` (
...
CREATE TABLE IF NOT EXISTS `{TABLE_PREFIX}request_limiter` (
                                                 `id` bigint UNSIGNED AUTO_INCREMENT COMMENT 'Unique identifier for this entry',
