...
/**
 * Class m200226_164343_add_thirdparty_average_price_to_3_tables
 */
class m200226_164343_add_thirdparty_average_price_to_3_tables extends Migration
{
    public function safeUp()
    {
        $fields = ['thirdparty_average'];
