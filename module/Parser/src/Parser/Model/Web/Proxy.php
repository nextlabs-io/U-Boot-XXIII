...
//        pr($sql);
    ...
    */
    ...
    {
        // Logging aggiuntivo per tracciare il valore di user_agent_id
        error_log("Controllo user_agent_id prima di addConnection. Valore: " . var_export($user_agent_id, true));
        
        // Controlla se user_agent_id è nullo
        if ($user_agent_id === null) {
            error_log("user_agent_id is null for url: $url");
            return false;
        }
